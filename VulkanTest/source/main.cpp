...
public:
    ...
    void createInstance() {
        ...
        if (enableValidationLayers) {
            ...
            //Adding debugging info for instance creation
    ...
    void createGraphicsPipeline() {
        ...
        vertexInputInfo.pVertexBindingDescriptions = &bindingDescription; // changed
        vertexInputInfo.vertexAttributeDescriptionCount = static_cast<uint32_t>(attributeDescriptions.size());
        vertexInputInfo.pVertexAttributeDescriptions = attributeDescriptions.data(); // changed
    ...
    void transitionImageLayout(VkImage image, VkFormat format,
        ...
        //aspectMask stuff updated when depth image
        ...
        if (oldLayout == VK_IMAGE_LAYOUT_UNDEFINED && newLayout == VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL) {
            ...
            throw std::invalid_argument("unsupported layout_transition!");
        }
    ...
    void updateUniformBuffers(uint32_t currentImage) {
        ...
        ubo.proj[1][1] *= -1; //invert Y clip coordinate

        //copy the data in uniform buffer object -> uniform Buffer
        void* data;
